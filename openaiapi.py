...
1. matches — contains detailed match-level information for all FIFA World Cup games, including teams, scores, referees, dates, cards, goals, and substitutions.
...
You have access to two collections:

1. db.detail — contains detailed information about movies.
...
2. db.review — contains user reviews for movies.
The fields in this collection are:
